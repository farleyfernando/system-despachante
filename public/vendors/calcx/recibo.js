		...
		select: function(event, ui) {
			...
			if (ui.item.value === 'Serviço não localizado !!!') {
				...
				var markup = '<tr>\
                    ...
                    <td class="text-center"><input type="hidden" name="valor_desconto_servico[]" data-cell="H' + i + '"  data-format="R$ 0,0.00" data-formula="((C' + i + '*D' + i + ')-F' + i + ')"><a title="Remover o servico" class="btn-remove text-danger"><i class="fa fa-close mt-2"></i></a></td>\
                </tr>';
