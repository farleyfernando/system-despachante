                                    ...
                                    <?php foreach ($clientes as $client) : ?>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a title="Excluir Cliente"href="javascript(void)" data-toggle="modal" 
                                                data-target="#user-<?php echo $client->cliente_id; ?>"><i class="fa fa-close" style="color:red"></i></a>
                    
                                        </td>                               
                                    </tr>
                                    
                                        <!-- Confirma exclusão Modal-->
                                            <div class="modal fade" id="user-<?php echo $client->cliente_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
