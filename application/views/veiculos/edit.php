				...
				<div class="x_content">
					...
					<form class="form-label-left input_mask" method="post">
						<p><strong><i class="fa fa-clock-o"></i>&nbsp; Última atualização: </strong><?php echo
							formata_data_banco_com_hora($veiculo->veiculo_data_alteracao) ?></p>
							...
							<div class="form-group row">
								<div class="col-md-2">
									...
									$veiculo->veiculo_placa; ?>" placeholder="___-___" required>
								...
								<div class="col-md-3">
									...
									echo $veiculo->veiculo_marca_modelo; ?>" placeholder="Marca/Modelo" required>
								...
								<div class="col-md-2">
									...
									<select class="form-control" name="veiculo_tipo_id">
										<?php foreach ($tipos as $tipo): ?>
											<option value="<?php echo $tipo->tipo_id ?>" <?php echo ($tipo->tipo_id
											== $veiculo->veiculo_tipo_id ? 'selected':'') ?> <?php echo
											($tipo->tipo_ativo == 0 ? 'disabled' : '')?>><?php echo
												($tipo->tipo_ativo ==
												0 ? $tipo->tipo_nome.'&nbsp; ->&nbsp;Inativa': $tipo->tipo_nome)
												?></option>
										<?php endforeach; ?>
									</select>
								</div>
								<div class="col-md-1">
									...
									echo $veiculo->veiculo_uf; ?>" placeholder="UF">
								...
								<div class="col-md-2">
									...
									<select class="form-control" name="veiculo_especie_id">
										<?php foreach ($especies as $especie): ?>
											...
											($especie->especie_id
											== $veiculo->veiculo_especie_id ? 'selected':'') ?> <?php echo
											($especie->especie_ativo == 0 ? 'disabled' : '')?>><?php echo
												($especie->especie_ativo ==
												0 ? $especie->especie_nome.'&nbsp; ->&nbsp;Inativa':
								...
								<div class="col-md-2">
									...
									<select class="form-control" name="veiculo_cor_id">
										<?php foreach ($cores as $cor): ?>
											...
											($cor->cor_id
											== $veiculo->veiculo_cor_id ? 'selected':'') ?> <?php echo
							...
							<div class="form-group row">
								<div class="col-md-2">
									...
									<select class="form-control" name="veiculo_combustivel_id">
										<?php foreach ($combustiveis as $combustivel): ?>
											...
											== $veiculo->veiculo_combustivel_id ? 'selected':'') ?> <?php echo
								...
								<div class="col-md-2">
									...
									<select class="form-control" name="veiculo_fabricacao">
										<option value="NACIONAL" <?php echo ($veiculo->veiculo_fabricacao == "NACIONAL") ? 'selected' :
												'';
										?>>NACIONAL</option>
										<option value="IMPORTADO" <?php echo ($veiculo->veiculo_fabricacao == "IMPORTADO") ? 'selected' :
												'';
										?>>IMPORTADO</option>
									</select>
								</div>
								<div class="col-md-2">
									...
									<select class="form-control" name="veiculo_categoria_id">
										<?php foreach ($categorias as $categoria): ?>
											...
											== $veiculo->veiculo_categoria_id ? 'selected':'') ?> <?php echo
								...
								<div class="col-md-2">
									...
									echo $veiculo->veiculo_ano_fab; ?>" placeholder="Ano Fab." required>
								...
								<div class="col-md-2">
									...
									echo $veiculo->veiculo_ano_mod; ?>" placeholder="Ano Fab." required>
								...
								<div class="col-md-2">
									...
									echo $veiculo->veiculo_potencia; ?>" placeholder="Potência">
							...
							<div class="form-group row">
								<div class="col-md-3">
									...
									echo $veiculo->veiculo_chassi; ?>" placeholder="Chassi">
								...
								<div class="col-md-2">
									...
									echo $veiculo->veiculo_cilindros; ?>" placeholder="Cilindros">
								...
								<div class="col-md-2">
									...
									echo $veiculo->veiculo_cilindrada; ?>" placeholder="Cilindrada">
								...
								<div class="col-md-3">
									...
									<select class="form-control" name="veiculo_chassi_rem">
										<option value="0" <?php echo ($veiculo->veiculo_chassi_rem == 0) ? 'selected' :
												'';	?>>Não</option>
										<option value="1" <?php echo ($veiculo->veiculo_chassi_rem == 1) ? 'selected' :
												'';	?>>Sim</option>
									</select>
								</div>
								<div class="col-md-2">
									...
									echo $veiculo->veiculo_lugares; ?>" placeholder="Lugares">
							...
							<div class="form-group row">
								<div class="col-md-4">
									...
									echo $veiculo->veiculo_renavam; ?>" placeholder="Renavam" required>
							...
							text-danger">','</small>'); ?>
								...
								<div class="col-md-4">
									...
									echo $veiculo->veiculo_num_motor; ?>" placeholder="Nº Motor">
								...
								<div class="col-md-4">
									...
									echo $veiculo->veiculo_mun_emp; ?>" placeholder="Mun. Emplacamento">
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<div class="col-md-4">
										...
										echo $veiculo->veiculo_num_crv; ?>" placeholder="Nº crv">
							...
							text-danger">','</small>'); ?>
									...
									<div class="col-md-4">
										...
										echo $veiculo->veiculo_num_duda; ?>" placeholder="Nº duda">
								...
								<div class="form-group row">
									...
									<div class="col-6">
										...
										<textarea id="message" class="form-control" name="veiculo_restricao"
												  ...
												  data-parsley-validation-threshold="10" rows="5" cols="200"
												  style="max-height: 60px;min-width: 100"><?php echo
											$veiculo->veiculo_restricao; ?></textarea>
									</div>
								</div>
							</fieldset>

						<input type="hidden" name="veiculo_id" value="<?php echo $veiculo->veiculo_id; ?>">
