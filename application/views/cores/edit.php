				...
				<div class="x_content">
					...
					<form class="form-label-left input_mask" method="post">
						<p><strong><i class="fa fa-clock-o"></i>&nbsp; Última atualização: </strong><?php echo
							formata_data_banco_com_hora($cor->cor_data_alteracao) ?></p>
							...
							<div class="form-group row">
								<div class="col-md-6">
									...
									$cor->cor_nome; ?>" placeholder="Nome cor">
								...
								<div class="col-md-6">
									...
									<select class="form-control" name="cor_ativo">
										<option value="0" <?php echo ($cor->cor_ativo == 0) ? 'selected' : '';
										?>>Não</option>
										<option value="1" <?php echo ($cor->cor_ativo == 1) ? 'selected' : '';
										?>>Sim</option>
									</select>
								</div>
							</div>
						...
						<input type="hidden" name="cor_id" value="<?php echo $cor->cor_id; ?>">
						</div>
						<div class="clearfix"></div>
