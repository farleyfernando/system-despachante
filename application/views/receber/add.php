							...
							<fieldset class="mt-4 mb-2 p-2">
								...
								<div class="form-group row">
									...
									<div class="col-md-2">
										...
										<input type="date" class="form-control" name="conta_receber_data_venc"
											   placeholder="" value="<?php echo set_value('conta_receber_data_venc'); ?>">
									...
									<div class="col-md-2">
										...
										<input type="text" class="form-control money2" name="conta_receber_valor"
											   placeholder="Valor Conta" value="<?php echo set_value('conta_receber_valor'); ?>">
								...
								<div class="form-group row">
									<div class="col-12">
										...
										<textarea class="form-control" name="conta_receber_obs" style="max-height: 60px;min-width: 100%"
												  placeholder="Obs. conta"><?php echo set_value('conta_receber_obs'); ?></textarea>
