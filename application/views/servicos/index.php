            ...
            <?php $this->load->view('layout/sidebar'); ?>
                ...
                <!-- ============================================================== -->
                            ...
                            <div class="mt-3 mb-3" style="float: right;">
						        <a href="<?php echo base_url('servicos/add'); ?>"><i class="fa fa-user-plus fa-3x" style="color:seagreen"></i></a>
					        </div>
                        </div>
                        <div class="x_content">
                            <div class="row">
                                ...
                                <tbody>
                                    <?php foreach ($servicos as $servico) : ?>
                                        ...
                                        <td class="text-center">
                                            <a title="Editar serviços" href="<?php echo base_url('servicos/edit/'
													.$servico->servico_id) ?>" data-toggle="tooltip " data-placement="top">
                                            <i class=" fa fa-check"></i></a>
                                            <a title="Excluir servicoe"href="javascript(void)" data-toggle="modal" 
