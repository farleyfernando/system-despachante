...
$route['pag'] = 'Formas_pagamentos/index';
$route['pag/add'] = 'Formas_pagamentos/add';
$route['pag/edit/(:num)'] = 'Formas_pagamentos/edit/$1';
$route['pag/del/(:num)'] = 'Formas_pagamentos/del/$1';
...
$route['os/imprimirA4/(:num)'] = 'Ordem_servicos/imprimirA4/$1';
$route['os/imprimirTermica/(:num)'] = 'Ordem_servicos/imprimirTermica/$1';
